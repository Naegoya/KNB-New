...
<body class="animsition">
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->
					<a href="#" class="logo">
						<img src="{{ asset('style/images/icons/logo-knb.png')}}" alt="IMG-LOGO" width="150" height="150">
					</a>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url({{ asset('style/images/KNB-01.jpg);')}}" >
				...
				<div class="item-slick1" style="background-image: url({{ asset('style/images/KNB-04.jpg);')}}" >
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
